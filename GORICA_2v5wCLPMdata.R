...
data <- array(NA, c(p, n))  # create array with nrow=p and ncol=n in order to keep simulate data
...
H1 <- "kappaV > 0.40 ; omegaV > 0.40" #the specified RI-CLPM
H2 <- "kappaV < 0 ; omegaV < 0" #which included equal to 0 and thus represents the CLPM
H3 <- "kappaV > 0.40 ; omegaV < 0"
H3a <- "kappaV > 0.40 ; omegaV == 0"
H3b <- "kappaV > 0.40 ; omegaV < 0.40"
H4 <- "kappaV < 0 ; omegaV > 0.40"
H4a <- "kappaV == 0 ; omegaV > 0.40"
H4b <- "kappaV < 0.40 ; omegaV > 0.40" 
