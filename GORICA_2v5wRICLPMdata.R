...
H1 <- "kappaV > 0.03 ; omegaV > 0.03" #the specified RI-CLPM
H2 <- "kappaV < 0 ; omegaV < 0" #which included equal to 0 and thus represents the CLPM
H3 <- "kappaV > 0.03 ; omegaV < 0"
H3a <- "kappaV > 0.03 ; omegaV == 0"
H3b <- "kappaV > 0.03 ; omegaV < 0.03"
H4 <- "kappaV < 0 ; omegaV > 0.03"
H4a <- "kappaV == 0 ; omegaV > 0.03"
H4b <- "kappaV < 0.03 ; omegaV > 0.03" 
