...
while(simteller<=nsim){
  ...
  warning <- any(is.na(parameterEstimates(riclpmModel.kappa.Constrainedsim, standardized = T)[c(13:24,40:77),]))
  ...
  p6 ~~ uv*q6'
    ...
    warning <- any(is.na(parameterEstimates(riclpmModel.omega.Constrainedsim, standardized = T)[c(13:24,40:77),]))
  ...
  p6 ~~ uv*q6'
      ...
      warning <- any(is.na(parameterEstimates(riclpmConstrainedsim, standardized = T)[c(13:24,27,40:77),]))
    ...
    S1 <- vcov(riclpmConstrainedsim)[c(13,14), c(13,14)]
    S2 <- vcov(riclpmModel.kappa.Constrainedsim)[13,13]
    S3 <- vcov(riclpmModel.omega.Constrainedsim)[13,13]
    S4 <- vcov(riclpmConstrainedsim)[14,14]
    S5 <- vcov(riclpmConstrainedsim)[13,13]
