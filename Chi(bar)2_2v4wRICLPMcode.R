...
B2<-matrix(c(0.22, -0.07, -0.07, 0.28),byrow = T, 2) # alpha, beta, gamma, delta (Massellink et al., 2018)

#variances-covariances matrix of the parameters
...
while(simteller<=nsim){
  ...
  data[, (M+1):(2*M)] <- varxy[, (M+1):(2*M)] + xy[,2] 
...
#p-value for ChiBar2DiffTest
pvalueChiBar2DiffTest_clpm_riclpm
pvalueChiBar2DiffTest_clpm_riclpm.kappa
pvalueChiBar2DiffTest_clpm_riclpm.omega
pvalueChiBar2DiffTest_riclpm_riclpm.kappa
pvalueChiBar2DiffTest_riclpm_riclpm.omega


#p-value for Chi2DiffTest
pvalueChi2DiffTest_clpm_riclpm
pvalueChi2DiffTest_clpm_riclpm.kappa
pvalueChi2DiffTest_clpm_riclpm.omega
pvalueChi2DiffTest_riclpm_riclpm.kappa
pvalueChi2DiffTest_riclpm_riclpm.omega



#RIvariances
RIvariances2 #RICLPM
RIvariances3 #RICLPM with kappa (no omega)
RIvariances4 #RICLPM with omega (no kappa)

#AIC
AIC_clpm_riclpm
AICweights_clpm_riclpm


AIC_clpm_riclpm.kappa
AICweights_clpm_riclpm.kappa


AIC_clpm_riclpm.omega
AICweights_clpm_riclpm.omega


AIC_riclpm_riclpm.kappa
AICweights_riclpm_riclpm.kappa


AIC_riclpm_riclpm.omega
AICweights_riclpm_riclpm.omega




#add the number of persons and Omega_pop in the file's name before exporting output

write.csv(RIvariances2,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p_RIvariances2.csv", row.names = FALSE)
write.csv(RIvariances3,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p_RIvariances3.csv", row.names = FALSE)
write.csv(RIvariances4,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p_RIvariances4.csv", row.names = FALSE)
write.csv(pvalueChiBar2DiffTest_clpm_riclpm,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wpvalueChiBar2DiffTest_clpm_riclpm.csv", row.names = FALSE)
write.csv(pvalueChiBar2DiffTest_clpm_riclpm.kappa,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wpvalueChiBar2DiffTest_clpm_riclpm.kappa.csv", row.names = FALSE)
write.csv(pvalueChiBar2DiffTest_clpm_riclpm.omega,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wpvalueChiBar2DiffTest_clpm_riclpm.omega.csv", row.names = FALSE)
write.csv(pvalueChiBar2DiffTest_riclpm_riclpm.kappa,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wpvalueChiBar2DiffTest_riclpm_riclpm.kappa.csv", row.names = FALSE)
write.csv(pvalueChiBar2DiffTest_riclpm_riclpm.omega,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wpvalueChiBar2DiffTest_riclpm_riclpm.omega.csv", row.names = FALSE)
write.csv(pvalueChi2DiffTest_clpm_riclpm,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wpvalueChi2DiffTest_clpm_riclpm.csv", row.names = FALSE)
write.csv(pvalueChi2DiffTest_clpm_riclpm.kappa,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wpvalueChi2DiffTest_clpm_riclpm.kappa.csv", row.names = FALSE)
write.csv(pvalueChi2DiffTest_clpm_riclpm.omega,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wpvalueChi2DiffTest_clpm_riclpm.omega.csv", row.names = FALSE)
write.csv(pvalueChi2DiffTest_riclpm_riclpm.kappa,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wpvalueChi2DiffTest_riclpm_riclpm.kappa.csv", row.names = FALSE)
write.csv(pvalueChi2DiffTest_riclpm_riclpm.omega,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wpvalueChi2DiffTest_riclpm_riclpm.omega.csv", row.names = FALSE)
write.csv(AIC_clpm_riclpm,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wAIC_clpm_riclpm.csv", row.names = FALSE)
write.csv(AICweights_clpm_riclpm,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wAICweights_clpm_riclpm.csv", row.names = FALSE)
write.csv(AIC_clpm_riclpm.kappa,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wAIC_clpm_riclpm.kappa.csv", row.names = FALSE)
write.csv(AICweights_clpm_riclpm.kappa,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wAICweights_clpm_riclpm.kappa.csv", row.names = FALSE)
write.csv(AIC_clpm_riclpm.omega,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wAIC_clpm_riclpm.omega.csv", row.names = FALSE)
write.csv(AICweights_clpm_riclpm.omega,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wAICweights_clpm_riclpm.omega.csv", row.names = FALSE)
write.csv(AIC_riclpm_riclpm.kappa,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wAIC_riclpm_riclpm.kappa.csv", row.names = FALSE)
write.csv(AICweights_riclpm_riclpm.kappa,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wAICweights_riclpm_riclpm.kappa.csv", row.names = FALSE)
write.csv(AIC_riclpm_riclpm.omega,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wAIC_riclpm_riclpm.omega.csv", row.names = FALSE)
write.csv(AICweights_riclpm_riclpm.omega,"C:/PhD/Project2/Chi_2 and chi_bar_2/output/Non-Boundary/1000 iterations/RICLPM/0001/2v4w/25p/25p__2v4wAICweights_riclpm_riclpm.omega.csv", row.names = FALSE)
...
#1-pchisq((Chi2_clpm-Chi2_riclpm),(df_clpm-df_riclpm))>>>> calculate p-value from chi-square difference test
