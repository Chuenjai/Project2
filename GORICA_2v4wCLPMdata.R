...
H1 <- "kappaV > 0.06 ; omegaV > 0.07" 
H2 <- "kappaV < 0 ; omegaV < 0" 
H3 <- "kappaV > 0.06 ; omegaV < 0"
H3a <- "kappaV > 0.06 ; omegaV == 0"
H3b <- "kappaV > 0.06 ; omegaV < 0.07"
H4 <- "kappaV < 0 ; omegaV > 0.07"
H4a <- "kappaV == 0 ; omegaV > 0.07"
H4b <- "kappaV < 0.06 ; omegaV > 0.07" 
